...
class SimpleTest(unittest.TestCase):
    ...
    def test_annotate_only_text(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads(
            '{"entities":[{"end":4,"normalizations":[{"id":"ENSP00000371475","type":9606},{"id":"Q12888|TP53B_HUMAN","type":"uniprot:9606"}],"start":1}]}'))
    ...
    def test_annotate_only_text_and_autodetect(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads(
            '{"entities":[{"end":9,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":1},{"end":14,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":11}]}'))

        response = self.app.post('/annotate/post', data=json.dumps({"text": "p53 mouse tp53", "autodetect": "False"}),
                                 content_type='application/json')
        self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads(
            '{"entities":[{"end":3,"normalizations":[{"id":"ENSP00000269305","type":9606},{"id":"P04637|P53_HUMAN","type":"uniprot:9606"}],"start":1},{"end":14,"normalizations":[{"id":"ENSP00000371475","type":9606},{"id":"Q12888|TP53B_HUMAN","type":"uniprot:9606"}],"start":11}]}'))
    ...
    def test_annotate_ids_minus22_and_7227(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads(
            '{"entities":[{"end":3,"normalizations":[{"id":"FBpp0072177","type":7227},{"id":"P08841|TBB3_DROME","type":"uniprot:7227"}],"start":1}]}'))
    ...
    def test_annotate_other_data(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads(
            '{"entities":[{"end":63,"normalizations":[{"id":"SPAC9.02c.1","type":4896},{"id":"Q9UT25|YFY2_SCHPO","type":"uniprot:4896"}],"start":60},{"end":87,"normalizations":[{"id":"SPAC1556.08c.1","type":4896},{"id":"Q10343|AAKG_SCHPO","type":"uniprot:4896"}],"start":84},{"end":96,"normalizations":[{"id":"SPAC30.04c.1","type":4896},{"id":"Q9P7V2|ABC4_SCHPO","type":"uniprot:4896"}],"start":93}]}'))

        response = self.app.post('/annotate/post', data=json.dumps(
            {"text": "Brachydanio rerio  or danio rerio have aldh9a1a and ab-cb8"}), content_type='application/json')
        self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads(
            '{"entities":[{"end":47,"normalizations":[{"id":"ENSDARP00000118280","type":7955},{"id":"Q7ZVB2|A9A1A_DANRE","type":"uniprot:7955"}],"start":40},{"end":58,"normalizations":[{"id":"ENSDARP00000073658","type":7955},{"id":"Q56A55|ABCB8_DANRE","type":"uniprot:7955"}],"start":53}]}'))
