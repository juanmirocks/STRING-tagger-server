...
class SimpleTest(unittest.TestCase):
    ...
    def test_failing_of_server(self): 
	...
	response = self.app.post('/annotate/post', data=json.dumps({"text":"p53 mouse"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"text":"Tumor protein p53 and human CDK1 and mouse CDK1 and influenza"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"text":"p53 dhe .p53 dhe P53.1 dhe P5-3 dhe -p53 and and human"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"text":"Tumor prot.ein p53 and hu.m-an CDK1 and m.o-use CDK1 and influenza"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,10090","text":"p53"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22","text":"p53"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,10090","text":"Tumor prot.ein p53 and hu.m-an CDK1 and m.o-use CDK1 and influenza"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"text":"p53 mouse tp53","autodetect":"True"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"text":"p53 mouse tp53","autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,9606", "text":"p53 mouse tp53", "autodetect":"True"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":9,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":1},{"end":14,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":11}]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,9606", "text":"p53 mouse tp53", "autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":3,"normalizations":[{"id":"ENSP00000269305","type":9606},{"id":"P04637|P53_HUMAN","type":"uniprot:9606"}],"start":1},{"end":14,"normalizations":[{"id":"ENSP00000371475","type":9606},{"id":"Q12888|TP53B_HUMAN","type":"uniprot:9606"}],"start":11}]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,10090", "text":"p53 mouse tp53", "autodetect":"True"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":9,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":1},{"end":14,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":11}]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,10090", "text":"p53 mouse tp53", "autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":9,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":1},{"end":14,"normalizations":[{"id":"ENSMUSP00000104298","type":10090},{"id":"P02340|P53_MOUSE","type":"uniprot:10090"}],"start":11}]}'))


    def test_annotate_ids_minus22(self): 
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22", "text":"p53 human nucleus"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22", "text":"p53 human"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22", "text":"nucleus", "autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":7,"normalizations":[{"id":"GO:0005634","type":-22}],"start":1}]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22", "text":"tp53 mouse tp53 nucleus", "autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":23,"normalizations":[{"id":"GO:0005634","type":-22}],"start":17}]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22", "text":"tp53 mouse tp53 nucleus", "autodetect":"True"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,7227", "text":"p53 human", "autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
	...
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,7227", "text":"p53 human", "autodetect":"True"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":9,"normalizations":[{"id":"ENSP00000269305","type":9606},{"id":"P04637|P53_HUMAN","type":"uniprot:9606"}],"start":1}]}'))


    def test_annotate_ids_minus22_and_7227_and_9606(self): 
	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,7227,9606", "text":"p53 human", "autodetect":"False"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":9,"normalizations":[{"id":"ENSP00000269305","type":9606},{"id":"P04637|P53_HUMAN","type":"uniprot:9606"}],"start":1}]}'))

	response = self.app.post('/annotate/post', data=json.dumps({"ids":"-22,7227,9606", "text":"p53 human", "autodetect":"True"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        self.assertEquals(json.loads(response.data), json.loads('{"entities":[{"end":9,"normalizations":[{"id":"ENSP00000269305","type":9606},{"id":"P04637|P53_HUMAN","type":"uniprot:9606"}],"start":1}]}'))


    def test_annotate_other_data(self): 
        response = self.app.post('/annotate/post', data=json.dumps({"text":"AT2s2, 4cll3 and others are used to test arabidopsis and pfk27, gnd1 and -a-ar2 are used to test yeast"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        ...
        response = self.app.post('/annotate/post', data=json.dumps({"text":"Fission yeast and yeast and Schizosaccharomyces pombe have paa1 but only yeast has cbs2 and abc4"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
        ...
        response = self.app.post('/annotate/post', data=json.dumps({"text":"Brachydanio rerio  or danio rerio have aldh9a1a and ab-cb8"}), content_type='application/json')
	self.assertEquals(response.status_code, 200)
